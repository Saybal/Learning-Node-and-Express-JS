...
// file.readFile('data_1.txt', 'utf-8', (err, data) => { // Asychronous readFile. It is non-blocking method.
...
// const data = file.readFileSync('data_1.txt', 'utf-8'); //sychronous readFile. It is blocking method.
// console.log(data);

// console.log("After Reading...");

// Writing File
let Product = "Hello, this is a product description.";
...
// file.writeFile("products.json", product_json, err => {
//   if (err) {
...
// file.appendFile("products.json", Product, err => {
//   if (err) {
...
// Recommended method to read large file.
// const readStream = file.createReadStream("products.json", "utf-8");
...
const writeStream = file.createWriteStream("data_2.txt", "utf-8");

writeStream.write("Hello, this is a write stream example.\n");
writeStream.write("This allows us to write data in chunks.\n");
writeStream.write("End of the write stream example.");

// pipe: Tranfering data from one stream to another stream. It is used to read data from a readable stream and write it to a writable stream without manually handling the data events.

const readStream = file.createReadStream("data_1.txt", "utf-8");
